...
reserved_words.push(
  ...
  'ELSE',
  'END',
  // Additional Oracle functions and keywords
  'HOT_INTADMIN',
  'GET_SUBORDER_DETAILS_FN',
  'GET_COLLEGE_TEASER_PROFILE_FN',
  'RESP_UTIL_PKG',
  'GET_COLLEGE_LOGO_FN',
  'GET_COLLEGE_TITLE_TRANS_FN',
  'CALL_BACK_UTIL_PKG',
  'GET_CALL_BACK_FORM_NAME_FN',
  'SHOW_CB_FORM_BUTTON_FN',
  'PROVIDER_ENGAGEMENT_STATS_MV',
  'W_SEARCH_BOOSTING',
  'C_INSTITUTIONS_VW',
  'W_ORDER_ITEM',
  'W_INT_ULT_SEARCH_TEXT',
  'W_INSTITUTIONS_ORDER',
  'W_SRCH_BST_L2_SRCTXT_IDX1',
  'W_SRCH_BST_L1_SRCTXT_IDX1',
  'W_INT_ULT_SRCH_LIVE1_IDX',
  'W_INT_ULT_SRCH_LIVE2_IDX',
  'HOT_CMI',
  'HOT_INT',
  'HOT_INTADMIN'
);